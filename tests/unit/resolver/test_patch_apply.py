...
def test_patch_apply_with_empty_lines():
    ...
    original_content = '# PR Viewer\n\nThis React application allows you to view open pull requests from GitHub repositories in a GitHub organization. By default, it uses the Maestrist organization.\n\n## Setup'
...
-This React application allows you to view open pull requests from GitHub repositories in a GitHub organization. By default, it uses the Maestrist organization.
+This React application was created by Graham Neubig and Maestrist. It allows you to view open pull requests from GitHub repositories in a GitHub organization. By default, it uses the Maestrist organization."""
