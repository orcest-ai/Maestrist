...
def test_app_config_extended_from_toml(tmp_path: os.PathLike) -> None:
    ...
    This test verifies that the [extended] section is loaded into MaestristConfig.extended
...
"""
    ...
    # Load the TOML into the MaestristConfig instance
...
def test_app_config_extended_default(tmp_path: os.PathLike) -> None:
    ...
    MaestristConfig.extended remains its default (empty) ExtendedConfig.
    """
    config_content = """
[core]
workspace_base = "/tmp/workspace"
