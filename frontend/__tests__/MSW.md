...
> [!NOTE]
> **Maestrist vs SaaS Mode**
>
> Maestrist runs in two modes:
> - **Maestrist mode**: For local/self-hosted deployments where users provide their own LLM API keys and configure git providers manually
