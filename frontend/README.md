# Getting Started with the Maestrist Frontend

## Overview

This is the frontend of the Maestrist project. It is a React application that provides a web interface for the Maestrist project.
...
git clone https://github.com/orcest-ai/Maestrist.git

# Change the directory to the frontend
cd Maestrist/frontend
...
1. **Component Testing**
   ...
   - Use our custom [`renderWithProviders()`](https://github.com/orcest-ai/Maestrist/blob/ce26f1c6d3feec3eedf36f823dee732b5a61e517/frontend/test-utils.tsx#L56-L85) that wraps the components we want to test in our providers. It is especially useful for components that use Redux
...
1. **Chat Input Component Test**:
   [`__tests__/components/chat/chat-input.test.tsx`](https://github.com/orcest-ai/Maestrist/blob/main/frontend/__tests__/components/chat/chat-input.test.tsx)
...
2. **File Explorer Component Test**:
   [`__tests__/components/file-explorer/file-explorer.test.tsx`](https://github.com/orcest-ai/Maestrist/blob/main/frontend/__tests__/components/file-explorer/file-explorer.test.tsx)
