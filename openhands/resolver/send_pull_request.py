...
PR_SIGNATURE = (
    'Automatic fix generated by [Maestrist](https://github.com/orcest-ai/Maestrist/) 🙌'
)
...
def make_commit(
    ...
    git_user_email: str = 'openhands@orcest.ai',
) -> None:
...
def update_existing_pull_request(
    ...
    if not comment_message and additional_message:
        try:
            ...
            if explanations:
                comment_message = (
                    'Maestrist made the following changes to resolve the issues:\n\n'
                )
            ...
            comment_message = (
                'A new Maestrist update is available, but failed to parse or summarize '
                f'the changes:\n{additional_message}'
            )
