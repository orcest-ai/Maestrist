...
def handle_observation_deprecated_extras(extras: dict) -> dict:
    # These are deprecated in https://github.com/orcest-ai/Maestrist/pull/4881
    ...
    # formatted_output_and_error has been deprecated in https://github.com/orcest-ai/Maestrist/pull/6671
