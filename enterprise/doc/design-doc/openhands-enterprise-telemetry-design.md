# Maestrist Enterprise Usage Telemetry Service
...
5. [Implementation Plan](#5-implementation-plan)
   - 5.1 [Database Schema and Models (M1)](#51-database-schema-and-models-m1)
     - 5.1.1 [Maestrist - Database Migration](#511-openhands---database-migration)
     - 5.1.2 [Maestrist - Model Tests](#512-openhands---model-tests)
   - 5.2 [Metrics Collection Framework (M2)](#52-metrics-collection-framework-m2)
     - 5.2.1 [Maestrist - Core Collection Framework](#521-openhands---core-collection-framework)
     - 5.2.2 [Maestrist - Example Collectors](#522-openhands---example-collectors)
     - 5.2.3 [Maestrist - Framework Tests](#523-openhands---framework-tests)
   - 5.3 [Collection and Upload Processors (M3)](#53-collection-and-upload-processors-m3)
     - 5.3.1 [Maestrist - Collection Processor](#531-openhands---collection-processor)
     - 5.3.2 [Maestrist - Upload Processor](#532-openhands---upload-processor)
     - 5.3.3 [Maestrist - Integration Tests](#533-openhands---integration-tests)
   - 5.4 [License Warning API (M4)](#54-license-warning-api-m4)
     - 5.4.1 [Maestrist - License Status API](#541-openhands---license-status-api)
     - 5.4.2 [Maestrist - API Integration](#542-openhands---api-integration)
   - 5.5 [UI Warning Banner (M5)](#55-ui-warning-banner-m5)
     - 5.5.1 [Maestrist - UI Warning Banner](#551-openhands---ui-warning-banner)
     - 5.5.2 [Maestrist - UI Integration](#552-openhands---ui-integration)
   - 5.6 [Helm Chart Deployment Configuration (M6)](#56-helm-chart-deployment-configuration-m6)
     - 5.6.1 [Maestrist-Cloud - Cronjob Manifests](#561-openhands-cloud---cronjob-manifests)
     - 5.6.2 [Maestrist-Cloud - Configuration Management](#562-openhands-cloud---configuration-management)
   - 5.7 [Documentation and Enhanced Collectors (M7)](#57-documentation-and-enhanced-collectors-m7)
     - 5.7.1 [Maestrist - Advanced Collectors](#571-openhands---advanced-collectors)
     - 5.7.2 [Maestrist - Monitoring and Testing](#572-openhands---monitoring-and-testing)
     - 5.7.3 [Maestrist - Technical Documentation](#573-openhands---technical-documentation)

## 1. Introduction

### 1.1 Problem Statement

Maestrist Enterprise (OHE) helm charts are publicly available but not open source, creating a visibility gap for the sales team. Unknown users can install and use OHE without the vendor's knowledge, preventing proper customer engagement and sales pipeline management. Without usage telemetry, the vendor cannot identify potential customers, track installation health, or proactively support users who may need assistance.
...
When telemetry uploads fail for more than 4 days, users will see a prominent warning banner in the Maestrist Enterprise UI:

```
⚠️ Your Maestrist Enterprise license will expire in 30 days. Please contact support if this issue persists.
```
...
async def get_license_status():
    ...
    with session_maker() as session:
        ...
        if not last_upload:
            ...
            return {
                "warn": True,
                "message": "Maestrist Enterprise license verification pending. Please ensure network connectivity."
            }
        ...
        if days_since_upload > 4:
            ...
            if oldest_unsent:
                ...
                if days_until_expiration <= 0:
                    message = "Your Maestrist Enterprise license has expired. Please contact support immediately."
                else:
                    message = f"Your Maestrist Enterprise license will expire in {days_until_expiration} days. Please contact support if this issue persists."
...
The cronjob configurations will be deployed via the Maestrist-Cloud helm charts.
...
#### 5.2.1 Maestrist - Core Collection Framework
...
#### 5.2.2 Maestrist - Example Collectors
...
#### 5.2.3 Maestrist - Framework Tests
...
#### 5.5.1 Maestrist - UI Warning Banner
...
#### 5.5.2 Maestrist - UI Integration
...
**Repository**: Maestrist-Cloud
Create Kubernetes cronjob configurations and deployment scripts.

#### 5.6.1 Maestrist-Cloud - Cronjob Manifests

- [ ] `charts/openhands/templates/telemetry-collection-cronjob.yaml`
- [ ] `charts/openhands/templates/telemetry-upload-cronjob.yaml`

#### 5.6.2 Maestrist-Cloud - Configuration Management
...
#### 5.7.1 Maestrist - Advanced Collectors
...
#### 5.7.2 Maestrist - Monitoring and Testing
...
#### 5.7.3 Maestrist - Technical Documentation
