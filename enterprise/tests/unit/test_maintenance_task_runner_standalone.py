...
These tests work without Maestrist dependencies and focus on testing the core
...
class TestMaintenanceTaskRunnerStandalone:
    """Standalone tests for MaintenanceTaskRunner without Maestrist dependencies."""
