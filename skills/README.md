...
You can see an example of a knowledge-based agent in [Maestrist's github skill](https://github.com/orcest-ai/Maestrist/tree/main/skills/github.md).
...
You can see an example of a repo agent in [the agent for the Maestrist repo itself](https://github.com/orcest-ai/Maestrist/blob/main/.openhands/microagents/repo.md).
