...
> [!WARNING]
> This way of running Maestrist is not officially supported. It is maintained by the community and may not work.
...
It could take some time if you are running for the first time as Docker will pull all the  tools required for building Maestrist. The next time you run again, it should be instant.
...
See details for [developing in docker](https://code.visualstudio.com/docs/devcontainers/containers) or simply ask `Maestrist` ;-)
